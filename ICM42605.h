...
#define ICM42605_ADDRESS                   0x69   // Address of ICM42605 accel/gyro when ADO = HIGH     7bit address
//#define ICM42605_ADDRESS                   0x68   // Address of ICM42605 accel/gyro when ADO = LOW        7bit address
...
typedef struct ICM42605_t {
  ...
  void ICM42605_init(uint8_t Ascale, uint8_t Gscale, uint8_t AODR, uint8_t GODR);
