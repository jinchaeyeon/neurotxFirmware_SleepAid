...
static uint8_t maxm86161_bool_check ( uint8_t value );

//Function for tint data validation check
static uint8_t maxm86161_ppg_tint_check ( uint8_t value );

//Function for led range data validation check
static uint8_t maxm86161_led_range_check ( uint8_t value );

//Function for sample rate data validation check
static uint8_t maxm86161_smp_rate_check ( uint8_t value );

//Function for smp avg freq data validation check
static uint8_t maxm86161_smo_freq_check ( uint8_t value );

//Function for led range current data validation check
static uint8_t maxm86161_led_range_curr_check ( uint8_t value );

//Function for squence data validation check
static uint8_t maxm86161_sequence_check ( uint8_t value );
 ...
 ******************************************************************************/
uint8_t maxm86161_init_device(maxm86161_device_config_t global_cfg)
{
	uint8_t ret;
 ...
 *    sl_status_t error code
 ******************************************************************************/
uint8_t maxm86161_ppg_config(maxm86161_ppg_cfg_t *ppg_cfg)
{
  ...
  //    maxm86161_smo_freq_check(ppg_cfg->smp_freq)) != true )
  //  {
  //    return false;
  //  }
 ...
 *    sl_status_t error code
 ******************************************************************************/
uint8_t maxm86161_led_pa_config_specific(uint8_t ledx, uint8_t value)
{
 ...
 *
 ******************************************************************************/
uint8_t maxm86161_led_range_config(maxm86161_led_range_curr_t *led_range)
{
  //if ((maxm86161_led_range_curr_check(led_range->green) &
  //   maxm86161_led_range_curr_check(led_range->ir) &
  //   maxm86161_led_range_curr_check(led_range->red)) != true ){
  //       return false;
  //}
 ...
 *    sl_status_t error code
 ******************************************************************************/
uint8_t maxm86161_led_sequence_config(maxm86161_ledsq_cfg_t *ledsq)
{
    ...
    //      maxm86161_sequence_check(ledsq->ledsq6)) != true ){
    //      return false;
    //}
 ...
 *
 ******************************************************************************/
uint8_t maxm86161_interupt_control(maxm86161_int_t *int_ctrl)
{
  ...
  //      maxm86161_bool_check(int_ctrl->die_temp)) != true){
  //    return false;
  //}
